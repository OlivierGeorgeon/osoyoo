...
ROBOT_BODY_COLOR = name_to_rgb("darkblue")
...
class OsoyooCar:
    def __init__(self, batch):
        ...
        self.FLWheel = shapes.Rectangle(50, 100, 80, 36, color=ROBOT_BODY_COLOR, batch=self.batch)
        self.FLWheel.anchor_position = 40, 18
        self.FRWheel = shapes.Rectangle(50, -100, 80, 36, color=ROBOT_BODY_COLOR, batch=self.batch)
        self.FRWheel.anchor_position = 40, 18
        self.RLWheel = shapes.Rectangle(-50, 100, 80, 36, color=ROBOT_BODY_COLOR, batch=self.batch)
        self.RLWheel.anchor_position = 40, 18
        self.RRWheel = shapes.Rectangle(-50, -100, 80, 36, color=ROBOT_BODY_COLOR, batch=self.batch)
