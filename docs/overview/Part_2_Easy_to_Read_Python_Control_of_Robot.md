...
The arduino_secrets.h file contains your home (or workplace or wherever else you are currently using a Wi-Fi network) Wi-Fi identifying information and login password, hence its name and why it is kept separate from the other files in the GitHub repository.
...
--> If you don't have a file "arduino_secrets.h" in the \src\wifi subfolder of your Arduino PetitCat project, then take a look again at the Step above, or else just use any text or programmming editor to create a file "arduino_secrtes.h" containing the following lines:
