...
class EchoObject:
    ...
    def compute_center(self):
        ...
        for allo_coord in self.allo_coordinates:
            print("QUOOOOOOOOOOOOOi",allo_coord)
            sum_x += allo_coord[0]
            sum_y += allo_coord[1]
            i += 1
        self.center = (sum_x/i,sum_y/i)
    ...
    def try_and_add(self,echo_interaction):
        ...
        print("COOOOOOOOOOORDDDDDD",allocentric_coordinates, "CENTRRRREEEE",self.center)
        print("DISTANCE ==== ",math.dist(allocentric_coordinates,self.center))
