...
from ..Memory.EgocentricMemory.Experience import EXPERIENCE_CENTRAL_ECHO, EXPERIENCE_ALIGNED_ECHO, EXPERIENCE_BLOCK, \
    EXPERIENCE_IMPACT
...
class PhenomenonObject(Phenomenon):
    ...
    def update(self, affordance):
        ...
        similar_affordance_points = np.array([a.point for a in self.affordances if a.is_similar_to(affordance)])
