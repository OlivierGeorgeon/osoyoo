...
def integrate(memory):
    ...
    new_experiences = [e for e in memory.egocentric_memory.experiences.values()
                       if (e.clock >= memory.clock)]
    ...
    memory.allocentric_memory.move(Quaternion([0, 0, 0, 1]), position_correction, memory.clock)
