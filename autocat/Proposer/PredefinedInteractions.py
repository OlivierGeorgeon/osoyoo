...
def create_composite_interactions(actions, primitive_interactions):
    ...
    iwf = create_or_retrieve_primitive(primitive_interactions, actions[ACTION_WATCH], OUTCOME_FOCUS_FRONT, 0)
    for interaction in primitive_interactions:
    ...
    i811 = create_or_retrieve_primitive(primitive_interactions, actions[ACTION_FORWARD], OUTCOME_FLOOR, 1)
