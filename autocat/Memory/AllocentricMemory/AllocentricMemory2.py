...
class AllocentricMemory2:
    """The agent's allocentric memory made with an hexagonal grid."""

    def __init__(self, width, height, depth, cell_radius):
        ...
        # self.grid = np.zeros((self.width, self.height, self.depth), dtype=tuple)
    ...
    def most_interesting_pool(self, clock):
        ...
        visit = [(2, 0), (-1, 4), (-2, -4), (2, -2), (0, 4), (-2, -2), (2, -4), (1, 4), (-2, 0), (1, -4),
                 (2, 4), (-2, 2),
                 (0, -4), (2, 2), (-2, 4), (-1, -4)]
        visit = [(2, 0), (-1, 4), (-2, -4), (2, -2), (0, 4), (-2, -2), (2, -4), (1, 4), (-2, 0), (1, -4),
                 (2, 4), (-2, 2),
