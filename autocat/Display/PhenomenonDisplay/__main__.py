...
# Create a phenomenon
experience1 = Experience([200, 0, 0], EXPERIENCE_ALIGNED_ECHO, math.pi / 4, 0, experience_id=1)
...
experience2 = Experience([200, 0, 0], EXPERIENCE_ALIGNED_ECHO, -math.pi / 2, 0, experience_id=2)
affordance2 = Affordance(numpy.array([10, 50, 0], dtype=numpy.int16), experience2)
phenomenon.update(affordance2)

experience3 = Experience([200, -50, 0], EXPERIENCE_ALIGNED_ECHO, -math.pi / 2, 0, experience_id=3)
affordance3 = Affordance(numpy.array([100, 50, 0], dtype=numpy.int16), experience3)
phenomenon.update(affordance3)

experience4 = Experience([300, 0, 0], EXPERIENCE_ALIGNED_ECHO, 3 * math.pi / 4, 0, experience_id=4)
